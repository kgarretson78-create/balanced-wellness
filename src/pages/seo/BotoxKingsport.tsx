...
export const data = {
  ...
  intro: {
    ...
    body: [
      "Botox (onabotulinumtoxinA) is the world's most popular cosmetic treatment — and for good reason. At Balanced Wellness Medical Spa in Kingsport, Tennessee, our board-certified providers use Botox to temporarily relax the facial muscles that cause dynamic wrinkles, delivering smoother, younger-looking skin without surgery.",
      "Unlike surgical facelifts, Botox requires no downtime. The treatment takes just 10–15 minutes and results appear within 3–7 days, lasting 3–4 months on average. With regular treatments, many patients find that their muscles gradually retrain themselves, requiring less product over time.",
      "At our Kingsport clinic, we take a conservative, artistic approach to every Botox treatment — our philosophy is that the best results are the ones no one can tell you've had. Whether you're addressing forehead lines, crow's feet, frown lines, or looking for preventive Botox, we'll create a personalized plan that honors your natural beauty.",
    ],
  },
  benefits: [
    { title: "Smooth Forehead Lines", desc: "Relaxes the frontalis muscle to reduce horizontal forehead wrinkles significantly." },
    { title: "Soften Crow's Feet", desc: "Addresses the fine lines at the outer corners of the eyes caused by squinting and smiling." },
    { title: "Lift Brow Position", desc: "Strategic injection patterns can create a subtle, natural brow lift without surgery." },
    { title: "Frown Line Correction", desc: "Targets the glabellar muscles (the '11s') between the brows for a more relaxed expression." },
    { title: "Preventive Anti-Aging", desc: "Starting Botox in your late 20s or 30s can prevent wrinkles from forming in the first place." },
    { title: "No Downtime Required", desc: "Return to work and daily activities immediately after your appointment." },
    { title: "Quick Treatment", desc: "Most Botox sessions at our Kingsport clinic take only 10–15 minutes." },
    { title: "Long-Lasting Results", desc: "Results typically last 3–4 months with natural fadeout over time." },
    { title: "Migraine Relief", desc: "Botox is FDA-approved to help reduce chronic migraine frequency." },
  ],
  candidates: {
    goodFor: [
      "Adults 21+ with dynamic wrinkles (caused by muscle movement)",
      "Anyone seeking preventive anti-aging treatment",
      "Patients with forehead lines, crow's feet, or frown lines",
      "Individuals who want natural results without surgery",
      "Those experiencing chronic migraines",
      "People with excessive sweating (hyperhidrosis)",
    ],
    notFor: [
      "Pregnant or breastfeeding individuals",
      "Those with certain neuromuscular disorders",
      "Patients with known allergy to botulinum toxin",
      "Individuals on certain blood thinners (may need to pause)",
  ...
  expectations: [
    {
      ...
      icon: "📋",
      items: [
        "Free consultation to discuss your goals and facial anatomy",
        "Avoid alcohol 24 hours before your appointment",
        "Stop blood-thinning supplements (fish oil, vitamin E) if safe to do so",
        "Come with a clean face — no makeup required",
        "Your provider will map your facial muscles and mark injection points",
      ],
    },
    {
      phase: "During",
      icon: "💉",
      items: [
        "The treatment takes 10–15 minutes total",
        "Ultra-fine needles cause minimal discomfort",
        "Topical numbing cream available if desired",
        "Multiple precise injections targeting specific muscles",
        "You'll feel mild pinching — most patients compare it to a bug bite",
      ],
    },
    {
      phase: "After",
      icon: "✨",
      items: [
        "Results appear in 3–7 days, full effect by day 14",
        "Avoid rubbing the face or lying down for 4 hours post-treatment",
        "Stay out of intense heat (sauna, hot yoga) for 24 hours",
        "Mild redness or pinpoint bruising is normal and fades quickly",
        "Results last 3–4 months; schedule your follow-up in advance",
      ],
    },
  ],
  comparison: {
  ...
  relatedLinks: [
    { name: "Dysport in Kingsport TN", path: "/dysport-kingsport-tn", desc: "A faster-onset alternative to Botox." },
    { name: "Daxxify in Kingsport TN", path: "/daxxify-kingsport-tn", desc: "The longest-lasting neurotoxin available." },
    { name: "Lip Filler Kingsport TN", path: "/lip-filler-kingsport-tn", desc: "Natural lip volume and definition." },
    { name: "Injectables & Fillers", path: "/injectables", desc: "Full range of injectable treatments." },
    { name: "VIP Memberships", path: "/memberships", desc: "Save on monthly Botox with our Gold tier." },
    { name: "Before & After Gallery", path: "/gallery", desc: "See real Botox results from our patients." },
  ],
  schemaDescription: "Botox injections in Kingsport TN performed by board-certified providers at Balanced Wellness Medical Spa. FDA-approved neurotoxin treatment for wrinkle reduction and anti-aging.",
};

export default function BotoxKingsport() {
