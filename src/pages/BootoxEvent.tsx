...
export default function BootoxEvent() {
  ...
  return (
    <PageLayout>
      ...
      <section className="relative overflow-hidden bg-[#fbf8f3] py-12 md:py-20">
        <div
          aria-hidden="true"
          className="absolute -right-24 -top-24 h-80 w-80 rounded-full bg-[#dda6a1]/25 blur-3xl"
        />
        <div
          aria-hidden="true"
          className="absolute -bottom-28 -left-24 h-96 w-96 rounded-full bg-[#eecfca]/40 blur-3xl"
        />

        <div className="relative mx-auto max-w-4xl px-4 sm:px-6">
          <div className="overflow-hidden rounded-[2rem] border border-[#dda6a1]/45 bg-white/90 shadow-[0_24px_70px_rgba(87,63,57,0.10)] backdrop-blur-sm">
            <div className="px-6 py-10 text-center sm:px-10 md:px-16 md:py-14">
              <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#dda6a1]/50 bg-[#fbf2ef] px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-[#8f554f]">
              ...
              <div className="mx-auto my-8 h-px max-w-md bg-[#dda6a1]" />
              ...
              <div className="mx-auto grid max-w-2xl gap-4 text-left sm:grid-cols-3">
                <div className="flex items-start gap-3 rounded-2xl bg-[#fbf8f3] p-4">
                  <CalendarDays className="mt-0.5 h-5 w-5 shrink-0 text-[#b16b64]" />
                  <div>
                ...
                <div className="flex items-start gap-3 rounded-2xl bg-[#fbf8f3] p-4">
                  <Clock3 className="mt-0.5 h-5 w-5 shrink-0 text-[#b16b64]" />
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-foreground/45">
                      Time
                    </p>
                ...
                <div className="flex items-start gap-3 rounded-2xl bg-[#fbf8f3] p-4">
                  <MapPin className="mt-0.5 h-5 w-5 shrink-0 text-[#b16b64]" />
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-wider text-foreground/45">
                      Location
                    </p>
            ...
            <div className="border-y border-[#dda6a1]/35 bg-[#fffaf7] px-6 py-10 sm:px-10 md:px-16">
              <div className="mx-auto max-w-2xl">
                <p className="text-center text-xs font-semibold uppercase tracking-[0.28em] text-[#9a5e58]">
                  What to expect
                </p>
                ...
                <div className="mt-8 grid gap-3 sm:grid-cols-2">
                  {highlights.map((item) => (
                    <div
                      key={item}
                      className="flex items-center gap-3 rounded-xl border border-[#dda6a1]/30 bg-white px-4 py-3.5"
                    >
                      <span className="h-2 w-2 shrink-0 rounded-full bg-[#b16b64]" />
            ...
            <div className="px-6 py-10 sm:px-10 md:px-16">
              <div className="mx-auto max-w-2xl text-center">
                <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#9a5e58]">
                ...
                <div className="mt-7 grid gap-3 sm:grid-cols-3">
                  <button
                    type="button"
                    onClick={openBooking}
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-[#315b3b] px-5 py-3.5 text-sm font-semibold text-white transition-colors hover:bg-[#284c32]"
                  >
                    Book Jonesborough
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-[#dda6a1] bg-white px-5 py-3.5 text-sm font-semibold text-foreground transition-colors hover:bg-[#fff5f2]"
                  >
                    <MessageSquare className="h-4 w-4 text-[#b16b64]" />
                    Text us
                  </a>
                  <a
                    href={location.tel}
                    className="inline-flex items-center justify-center gap-2 rounded-full border border-[#dda6a1] bg-white px-5 py-3.5 text-sm font-semibold text-foreground transition-colors hover:bg-[#fff5f2]"
                  >
                    <Phone className="h-4 w-4 text-[#b16b64]" />
                    Call us
                  </a>
                </div>
