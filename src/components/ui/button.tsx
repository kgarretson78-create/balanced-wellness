    ...
    variants: {
      variant: {
        default:
           ...
           "bg-primary text-primary-foreground border border-primary-border shadow-[0_2px_8px_hsl(var(--primary)/0.22)] hover:shadow-[0_6px_18px_hsl(var(--primary)/0.30)] hover:-translate-y-px",
        destructive:
        ...
        secondary:
          ...
          "border bg-secondary text-secondary-foreground border border-secondary-border shadow-xs hover:shadow-sm ",
